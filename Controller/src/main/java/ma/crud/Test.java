...
public class Test {
    ...
    public void cs() throws ClassNotFoundException, SQLException {
     ...
     //  cccc Connection connection = DriverManager.getConnection("jdbc:mysql:loadbalance://192.168.1.226:3306,192.168.1.227:3306,192.168.1.230:3306/a?roundRobinLoadBalance=true","root","123123Qq#");
